...
export default function Home() {
  ...
  useEffect(() => {
    const fetchOfferListings = async () => {
      try {
        const res = await fetch('https://real-estate-web-application-owuv.onrender.com/listing/get?offer=true&limit=4');
    ...
    const fetchRentListings = async () => {
      try {
        const res = await fetch('https://real-estate-web-application-owuv.onrender.com/listing/get?type=rent&limit=4');
        const data = await res.json();
